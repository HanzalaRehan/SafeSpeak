...
INPUTS_DIR = ROOT / "inputs"   # inputs/{face_id}/{n}.png
...
class LipExtractor:
    ...
    def extract(self, frame_bgr: np.ndarray) -> list:
        """
...
class FrameBuffer:
    ...
    def flush(self, face_id: int) -> list:
...
def _save_sequence(face_id: int, frames: list):
